...
gui::Gui::Gui(int& width, int& height, const char*& title, bool& vsync, void (*setupTheme)()) {
    if (!glfwInit())
        std::cerr << "Failed to initialize GLFW" << std::endl;

    // Set OpenGL version (use at least 3.0 for ImGui)
...
void gui::Gui::Render(Gl_RGBA rgba) {
    ImGui::Render();
